...
- **Web AI 控制台 / 手机 PWA**：网页里直接问行情、查个股、开始/停止持仓跟踪、设置/取消盯价，可添加到手机主屏幕使用。
...
- Web AI console and mobile PWA for stock lookup, market questions, position tracking and buy-price alerts without connecting Feishu/Lark.
